    ...
    try:
        for i, (images, gts, depths) in enumerate(train_loader, start=1):
            ...
            # if i == total_step or i==1:
                print('{} Epoch [{:03d}/{:03d}], Step [{:04d}/{:04d}], Loss1: {:.4f} Loss2: {:0.4f} Loss3: {:0.4f} Loss4: {:0.4f}'.
                    format(datetime.now(), epoch, opt.epoch, i, total_step, loss1, loss2,  loss3, loss4))
                logging.info('#TRAIN#:Epoch [{:03d}/{:03d}], Step [{:04d}/{:04d}], Loss1: {:.4f} Loss2: {:0.4f} Loss3: {:0.4f} Loss4: {:0.4f}'.
